      ...
      <section className="py-24 border-t border-white/10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
            <div className="bg-white/5 rounded-2xl p-12 aspect-square flex items-center justify-center border border-white/10 order-2 md:order-1">
              <div className="text-center">
                <div className="w-32 h-32 bg-white/10 rounded-lg mx-auto mb-6"></div>
                <p className="text-white/50 font-sans">Litigation Solutions</p>
              </div>
            </div>
            <div className="order-1 md:order-2">
              ...
              <p className="text-lg text-white/70 mb-8 font-sans">
                LegalEyes helps litigation teams reduce manual work, focus on case strategy, and deliver stronger outcomes for clients.
              </p>
              <ul className="space-y-4">
                ...
                <li className="flex items-start">
                  ...
                  <span className="text-white/80 font-sans">Deposition and witness preparation tools</span>
                </li>
              </ul>
            </div>
          </div>
